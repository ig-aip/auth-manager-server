...
RUN apt-get update && apt-get install -y build-essential cmake git curl zip unzip tar pkg-config ninja-build libssl-dev libpq-dev bison flex autoconf automake libtool
